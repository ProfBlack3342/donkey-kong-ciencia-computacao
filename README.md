...
## Loop dos Score
Um loop que carrega e exibe os scores salvos em um arquivo binário. Os scores estão organizados pela lógica:
1. Maior Fase Alcançada
2. Menor Tempo
Possui somente um botão, que encerra o Loop dos Scores e retorna ao Loop do Menu
